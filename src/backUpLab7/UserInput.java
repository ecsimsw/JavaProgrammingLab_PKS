...
public class UserInput {
	...
	// getElement from user input (String->State) "GAS" -> GAS
	...
	public static PeriodicElement getPeriodicElement() {
		System.out.println("~~please input PeriodicElement~~"); 
		System.out.print("please input PeriodicElement number : "); 
		int number = UserInput.getInteger();
		System.out.print("please input PeriodicElement symbol : "); 
		String symbol = UserInput.getString();	
		System.out.print("please input PeriodicElement name : "); 
		String name = UserInput.getString();
		System.out.print("please input PeriodicElement weight : "); 
		double weight = UserInput.getDouble();	
		System.out.print("please input PeriodicElement state : "); 
